...
| passport_id | UUID | FK | Паспорт. Обязательное, если certificate_id не заполнен|
| certificate_id | UUID | FK | Свидетельство о рождении. Обязательное, если passport_id не заполнен |
