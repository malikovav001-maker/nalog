...
<img width="1022" height="958" alt="Диаграмма без названия-Страница-1 drawio" src="https://github.com/user-attachments/assets/e9bb4ac9-5156-471a-b5f9-336847beb1f7" />
## Логическая модель
```plantuml
@startuml
...
| --- | --- | --- | --- |
| status_id | INTEGER | PK | Уникальный идентификатор |
...
| **Атрибут** | **Тип данных** | **Ограничение** | **Описание** |
| --- | --- | --- | --- |
| category_id | INTEGER | PK | Уникальный идентификатор |
...
| **Атрибут** | **Тип данных** | **Ограничение** | **Описание** |
| --- | --- | --- | --- |
| type_id | INTEGER | PK | Уникальный идентификатор |
...
| date_update | TIMESTAMP | NOT NULL, DEFAULT NOW(), CHECK (date_update >= date_create) | Дата последнего изменения |
...
| passport_id | INTEGER | FK | Паспорт |
| certificate_id | INTEGER | FK | Свидетельство о рождении |
| inn | INTEGER |  | ИНН |
| date_create | TIMESTAMP | NOT NULL, DEFAULT NOW() | Дата создания |
| date_update | TIMESTAMP | NOT NULL, DEFAULT NOW(), CHECK (date_update >= date_create) | Дата последнего изменения |
...
| applicanttype_id | INTEGER | FK, NOT NULL | Тип получателя |
...
| category_id | INTEGER | FK, NOT NULL | Категория расходов |
...
| status_id | INTEGER | PK | Статус заявления |
